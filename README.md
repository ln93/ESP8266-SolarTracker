...
boot.py：通过配置是否联网获取lon（经度）决定使用太阳时或北京时间。
...
在白昼时，ESP8266大多数时间处于轻度睡眠状态，但每隔3小时将尝试联网同步时间————如此高的频率是因为8266的RTC太糟糕了，一个小时能差五分钟。在8266正在联网（或无法联网）时，屏幕将显示天线图标。由于8266联网的时间很短暂，因此当你看到天线图标时，大概率是因为8266连不上网。
